...
export function AddAgentInboxDialog() {
  ...
  return (
    ...
    <DialogContent className="sm:max-w-[425px]">
      ...
      <form className="flex flex-col items-center justify-center gap-4 py-4 w-full" onSubmit={handleSubmit}>
        ...
        <div className="grid grid-cols-2 gap-4">
          ...
          <Button variant="outline" type="reset" onClick={() => setOpen(false)}>Cancel</Button>
        </div>
      </form>
    </DialogContent>
  </Dialog>
